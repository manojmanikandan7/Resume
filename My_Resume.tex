...
\begin{itemize}
  \item \textbf{Year 2: } \textbf{81\%}, One of the \textbf{Top 10} students in the cohort.
  \item \textbf{Courses:} Software Engineering, Data Structures and
    Algorithms, System-on-Chip, Quantum Computing, Database Systems, Artificial Intelligence, Machine Learning,
...
\begin{itemize}
  ...
  \item Crafted an \href{https://github.com/manojmanikandan7/PolishMagTextRecog}{application} for analysis and extraction of texts from Polish magazine scans.
\end{itemize}
...
\section*{SKILLS}
\begin{itemize}
  \item \textbf{Programming and tools:} Java, Spring Boot, Python, ARMv7 \& RISC-V assembly, Verilog, SystemVerilog,
    Rust, C, C++, Haskell, PHP, ReactJS, JavaScript, PostgreSQL, Questa Sim.
  \item \textbf{Technical:} Deep Learning, Convolutional Neural
    Networks, Recurrent Neural Networks, LSTM, GRU, Language Models,
    Transformers, Transfer Learning, Vector Space Modelling, FPGA Systhesis.
...
\begin{itemize}
  \item Scored \textbf{92\%} for the project grade, for code
    quality and presentation.
  \item Collaborated with \textbf{6 students} to develop a
    budget tracker curated for students, as part of the First-Year Team
    Project.
...
\begin{itemize}
  ...
  \item Nominated as a Student Representative for a class of around
    \textbf{400} Computer Science students.
